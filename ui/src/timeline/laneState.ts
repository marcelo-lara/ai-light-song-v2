...
export const LANE_DEFS: readonly LaneDef[] = [
  ...
  { id: "vocalVoiceness", label: "4. Vocal Voiceness", sub: "experiment · per-frame voiceness (vibrato + portamento + sibilance) + bridged phrase blocks", kind: "proposals", height: 50, experiment: "vocal_voiceness" },
  { id: "svdTagger", label: "6. SVD Tagger", sub: "experiment · PANNs Singing-class voiceness, stem + mix channels (two curves, no toggle)", kind: "proposals", height: 50, experiment: "svd_tagger" },
  { id: "whisperxVad", label: "7. WhisperX VAD", sub: "speech-domain VAD voiceness + phrase spans with real sub-second onsets (diarization not attempted — no HF_TOKEN)", kind: "proposals", height: 50 },
  { id: "voiceMultiplicity", label: "Voice Multiplicity", sub: "experiment · solo/stacked voice blocks from stereo width and L-R correlation", kind: "proposals", height: 50, experiment: "voice_multiplicity" },
  { id: "phrasePeriodicity", label: "3. Phrase Periodicity", sub: "experiment · per-bar autocorrelation regime + period", kind: "proposals", height: 50, experiment: "phrase_periodicity" },
