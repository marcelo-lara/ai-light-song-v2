...
export const LANE_DEFS: readonly LaneDef[] = [
  ...
  { id: "energyLevel", label: "Energy Level", sub: "experiment · mix loudness + stems-playing fraction -> energy 1-5", kind: "proposals", height: 58, experiment: "energy_level" },
  { id: "tensionShape", label: "Tension Shape", sub: "experiment · energy slope + gesture/regime overlap -> tension 1-5", kind: "proposals", height: 58, experiment: "tension_shape" },
