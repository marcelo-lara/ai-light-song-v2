"""CLI entry point.
    ...
    python -m experiments.energy_level.run compute [--all] [--song NAME]
    python -m experiments.energy_level.run export  [--all] [--song NAME]
    python -m experiments.energy_level.run score
"""
