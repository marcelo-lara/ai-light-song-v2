"""CLI entry point.
    ...
    python -m experiments.rhythm_stem_autocorr.run compute [--all] [--song NAME]
    python -m experiments.rhythm_stem_autocorr.run export  [--all] [--song NAME]
    python -m experiments.rhythm_stem_autocorr.run score
"""
