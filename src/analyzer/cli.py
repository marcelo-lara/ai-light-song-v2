...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--compare", default="beats,chords,drums,sections,energy,events,form,drops")
...
def main(argv: list[str] | None = None) -> int:
    ...
    supported_targets = {"beats", "chords", "drums", "sections", "energy", "events", "form", "drops"}
    try:
