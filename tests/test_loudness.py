...
class LoudnessExtractionTests(unittest.TestCase):
    def test_extract_mix_stem_loudness_writes_rms_and_envelope_artifacts(self) -> None:
        ...
        self.assertEqual(rms_written["metadata"]["history_windows_s"], [2.0, 5.0])
        ...
        self.assertIn("history", rms_written["frames"][0])
        self.assertIn("mean_2s", rms_written["frames"][0]["history"])
        self.assertIn("peak_5s", rms_written["frames"][0]["history"])
