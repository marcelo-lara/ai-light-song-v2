...
//
// The badged set currently has seven lanes (v3.4 item 6 added
// `textureNovelty`). Plan v3.0 item 9 promoted
...
test("item 7 — flask badge on unpromoted-experiment lane heads", async ({ page }) => {
  ...
  // 4. whole-document count is exactly BADGED.length.
