...
[`../ui-regression_guide.md`](../../../reference/ui-regression_guide.md).

| File | What it is |
| --- | --- |
| [`design/design-notes.md`](../../../reference/ui-design/design-notes.md) | Nocturne tokens, layout anatomy, per-lane spec (incl. §3a — the FFT/RMS/Envelope palette carried verbatim from the previous app), the 3-mode right panel, and how each lane maps onto a real analyzer artifact. |
| [`design/Score-Analysis-DAW.dc.html`](../../../reference/ui-design/Score-Analysis-DAW.dc.html) | The Claude Design canvas markup + behavioural script, verbatim, as the visual/interaction reference. |
