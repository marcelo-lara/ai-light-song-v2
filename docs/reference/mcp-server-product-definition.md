> **Definition of a component that does not exist yet.** Nothing in `src/` or
> `mcp/` implements this. It is kept here as reference for *what the component
> is*; the *work items* to build it belong in the single
> `docs/product-refinement-vX.Y.md` (constitution §4.1), not in a plan of its
> own.
...
[implementation-plan.md](../archive/mcp-server-implementation-plan.md).
...
[analysis-input-guide.md](analysis-input-guide.md)
...
[analysis-input-guide.md](analysis-input-guide.md) uses
...
[analysis-input-guide.md](analysis-input-guide.md) §3;
